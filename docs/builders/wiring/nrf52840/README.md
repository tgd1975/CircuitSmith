# nRF52840 Feather default build

Generated artefacts for the nRF52840 target. Re-rendered from
[`data/nrf52840.circuit.yml`](../../../../data/nrf52840.circuit.yml) by
the renderer pipeline; do not edit by hand. The CI staleness guard
fails the build if any file here drifts from a fresh render.
