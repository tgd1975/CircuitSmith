...
**Epics:** [circuit-skill-packaging](#circuit-skill-packaging) · [post-epic-006-doc-audit](#post-epic-006-doc-audit) · [test-plan-and-coverage](#test-plan-and-coverage) · [tutorial-and-examples](#tutorial-and-examples)
...
kanban
  Open
    TASK_092["Decide docs/users/ structure and update README pointer"]
    TASK_093["Scaffold docs/users/tutorial/ and docs/users/examples/ with indexes"]
    TASK_094["Tutorial — steps 1-3 (minimal circuit, fan-out, sub-blocks)"]
    TASK_095["Tutorial — steps 4-6 (ERC fix, BOM export, layout iteration)"]
    TASK_096["Example gallery — voltage divider"]
    TASK_097["Example gallery — common-emitter amplifier"]
    TASK_098["Example gallery — 555 monostable timer"]
    TASK_099["Example gallery — op-amp non-inverting buffer"]
    TASK_100["Example gallery — multi-page split (stresses renderer page-break)"]
    TASK_101["CI regression diff — regenerate the tutorial and gallery, fail on drift"]
  Active
  Paused
  Closed
```
