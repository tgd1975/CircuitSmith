...
- [x] `docs/builders/wiring/esp32/erc-report.md` exists and reflects current ERC findings.
- [x] `docs/builders/wiring/nrf52840/erc-report.md` exists and reflects current ERC findings.
- [x] Both reports contain the "Pending promotions" rationale block for E9.
- [x] Reports are produced by the renderer (not hand-edited) — re-running the pipeline produces byte-identical output.
