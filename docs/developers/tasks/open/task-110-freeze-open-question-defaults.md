...
- [ ] Every open question from IDEA-008 has a recorded decision in the epic body or an ADR.
- [ ] Every open question from IDEA-009 has a recorded decision in the epic body or an ADR.
- [ ] The two idea bodies' *Open questions* sections are updated to mark the resolved defaults as Decided (with a back-pointer to the epic body or ADR).
