...
**Overall:** 🔵 **active** — ██████░░░░ 45/79 (57%) across 11 groups — 34 open · 0 active · 0 paused · 45 closed
...
| [EPIC-010](#epic-010-consolidate-skill-resident-python-into-circuitsmith-package) | Consolidate skill-resident Python into circuitsmith package | ⚪ _open_ | 4 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 1 | 0 | 0 | 1 | █████░░░░░ 50% |
...
```mermaid
graph LR
    TASK_076["TASK-076"]:::open
    TASK_077["TASK-077"]:::open
    TASK_078["TASK-078"]:::open
    TASK_079["TASK-079"]:::open
    TASK_076 --> TASK_077
    TASK_077 --> TASK_078
    TASK_077 --> TASK_079
    click TASK_076 "open/task-076-write-adr-0012-supersede-adr-0007.md"
    click TASK_077 "open/task-077-atomic-relocation-to-src-circuitsmith.md"
    click TASK_078 "open/task-078-update-agent-facing-surface.md"
    click TASK_079 "open/task-079-repo-docs-sweep-and-changelog.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-076](open/task-076-write-adr-0012-supersede-adr-0007.md) | Write ADR-0012 (library as installable package) superseding ADR-0007 | ⚪ _open_ | Medium (2-8h) |
| 2 | [TASK-077](open/task-077-atomic-relocation-to-src-circuitsmith.md) | Atomic relocation of circuit package to src/circuitsmith/ | ⚪ _open_ | Large (8-24h) |
| 3 | [TASK-078](open/task-078-update-agent-facing-surface.md) | Update agent-facing surface for circuitsmith package rename | ⚪ _open_ | Small (&lt;2h) |
| 4 | [TASK-079](open/task-079-repo-docs-sweep-and-changelog.md) | Repo docs sweep and CHANGELOG bullet for circuitsmith refactor | ⚪ _open_ | Small (&lt;2h) |
...
```mermaid
graph LR
    TASK_075["TASK-075"]:::open
    TASK_060["TASK-060"]:::closed
    TASK_060 ~~~ TASK_075
    click TASK_075 "open/task-075-fix-idea-skill-template-markdownlint.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| ? | [TASK-075](open/task-075-fix-idea-skill-template-markdownlint.md) | Fix /ts-idea-new template so generated files pass markdownlint on first run | ⚪ _open_ | Small (&lt;2h) |
