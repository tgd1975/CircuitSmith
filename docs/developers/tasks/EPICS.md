...
**Overall:** 🔵 **active** — ██████████ 132/135 (98%) across 15 groups — 3 open · 0 active · 0 paused · 132 closed
...
| [EPIC-011](#epic-011-test-plan-and-coverage-matrix) | Test Plan and Coverage Matrix | 🟢 closed | 0 | 0 | 0 | 9 | ██████████ 100% |
| [EPIC-012](#epic-012-tutorial-and-example-gallery) | Tutorial and Example Gallery | 🟢 closed | 0 | 0 | 0 | 10 | ██████████ 100% |
| [EPIC-013](#epic-013-post-epic-006-documentation-audit-and-rewrite) | Post-EPIC-006 Documentation Audit and Rewrite | 🟢 closed | 0 | 0 | 0 | 8 | ██████████ 100% |
| [EPIC-014](#epic-014-component-library-and-renderer-v2-sub-blocks-active-devices-multi-page) | Component library and renderer v2 (sub-blocks, active devices, multi-page) | 🟢 closed | 0 | 0 | 0 | 24 | ██████████ 100% |
| [—](#unassigned) | _(no epic)_ | 🔵 **active** | 2 | 0 | 0 | 2 | █████░░░░░ 50% |
...
**Status:** 🟢 closed — @branch: release/epic-011-test-plan-and-coverage — ██████████ 9/9 (100%)

```mermaid
graph LR
    TASK_083["TASK-083"]:::closed
    TASK_084["TASK-084"]:::closed
    TASK_085["TASK-085"]:::closed
    TASK_086["TASK-086"]:::closed
    TASK_087["TASK-087"]:::closed
    TASK_088["TASK-088"]:::closed
    TASK_089["TASK-089"]:::closed
    TASK_090["TASK-090"]:::closed
    TASK_091["TASK-091"]:::closed
    TASK_083 --> TASK_084
    TASK_084 --> TASK_085
    TASK_084 --> TASK_086
    TASK_084 --> TASK_087
    ...
    TASK_089 --> TASK_091
    TASK_090 --> TASK_091
    click TASK_083 "closed/task-083-scaffold-testing-docs-directory.md"
    click TASK_084 "closed/task-084-inventory-existing-test-surface.md"
    click TASK_085 "closed/task-085-document-schema-and-netgraph-test-plan.md"
    click TASK_086 "closed/task-086-document-layout-and-router-test-plan.md"
    click TASK_087 "closed/task-087-document-renderer-and-erc-test-plan.md"
    click TASK_088 "closed/task-088-document-exporters-orchestration-ci-test-plan.md"
    click TASK_089 "closed/task-089-write-top-level-coverage-matrix.md"
    click TASK_090 "closed/task-090-file-followup-tasks-for-coverage-gaps.md"
    click TASK_091 "closed/task-091-ci-staleness-check-for-test-plan.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | ~~[TASK-083](closed/task-083-scaffold-testing-docs-directory.md)~~ | ~~Scaffold docs/developers/testing/ directory and top-level index~~ | 🟢 closed | Small (&lt;2h) |
| 2 | ~~[TASK-084](closed/task-084-inventory-existing-test-surface.md)~~ | ~~Inventory the existing test surface and tag every test by subsystem and layer~~ | 🟢 closed | Small (&lt;2h) |
| 3 | ~~[TASK-085](closed/task-085-document-schema-and-netgraph-test-plan.md)~~ | ~~Author the schema and netgraph subsystem test plans~~ | 🟢 closed | Medium (2-8h) |
| 4 | ~~[TASK-086](closed/task-086-document-layout-and-router-test-plan.md)~~ | ~~Author the layout-kernel and Manhattan-router subsystem test plans~~ | 🟢 closed | Medium (2-8h) |
| 5 | ~~[TASK-087](closed/task-087-document-renderer-and-erc-test-plan.md)~~ | ~~Author the renderer and ERC-engine subsystem test plans~~ | 🟢 closed | Medium (2-8h) |
| 6 | ~~[TASK-088](closed/task-088-document-exporters-orchestration-ci-test-plan.md)~~ | ~~Author the exporters, skill-orchestration, and CI-gates subsystem test plans~~ | 🟢 closed | Medium (2-8h) |
| 7 | ~~[TASK-089](closed/task-089-write-top-level-coverage-matrix.md)~~ | ~~Write the top-level coverage matrix with the PR-time/nightly/release axis~~ | 🟢 closed | Medium (2-8h) |
| 8 | ~~[TASK-090](closed/task-090-file-followup-tasks-for-coverage-gaps.md)~~ | ~~File concrete follow-up tasks for every coverage gap exposed by the plan~~ | 🟢 closed | Small (&lt;2h) |
| 9 | ~~[TASK-091](closed/task-091-ci-staleness-check-for-test-plan.md)~~ | ~~Add a CI staleness check that flags tests not referenced in the plan~~ | 🟢 closed | Medium (2-8h) |
...
```mermaid
graph LR
    TASK_092["TASK-092"]:::closed
    TASK_093["TASK-093"]:::closed
    TASK_094["TASK-094"]:::closed
    TASK_095["TASK-095"]:::closed
    TASK_096["TASK-096"]:::closed
    TASK_097["TASK-097"]:::closed
    TASK_098["TASK-098"]:::closed
    TASK_099["TASK-099"]:::closed
    TASK_100["TASK-100"]:::closed
    ...
    TASK_099 --> TASK_101
    TASK_100 --> TASK_101
    click TASK_092 "closed/task-092-decide-docs-users-structure.md"
    click TASK_093 "closed/task-093-scaffold-tutorial-and-examples-directories.md"
    click TASK_094 "closed/task-094-tutorial-steps-1-3-minimal-and-fan-out.md"
    click TASK_095 "closed/task-095-tutorial-steps-4-6-erc-bom-iteration.md"
    click TASK_096 "closed/task-096-example-voltage-divider.md"
    click TASK_097 "closed/task-097-example-common-emitter-amplifier.md"
    click TASK_098 "closed/task-098-example-555-monostable.md"
    click TASK_099 "closed/task-099-example-opamp-non-inverting-buffer.md"
    click TASK_100 "closed/task-100-example-multi-page-split.md"
    click TASK_101 "closed/task-101-ci-regression-diff-for-gallery.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | ~~[TASK-092](closed/task-092-decide-docs-users-structure.md)~~ | ~~Decide docs/users/ structure and update README pointer~~ | 🟢 closed | Small (&lt;2h) |
| 2 | ~~[TASK-093](closed/task-093-scaffold-tutorial-and-examples-directories.md)~~ | ~~Scaffold docs/users/tutorial/ and docs/users/examples/ with indexes~~ | 🟢 closed | Small (&lt;2h) |
| 3 | ~~[TASK-094](closed/task-094-tutorial-steps-1-3-minimal-and-fan-out.md)~~ | ~~Tutorial — steps 1-3 (minimal circuit, fan-out, sub-blocks)~~ | 🟢 closed | Medium (2-8h) |
| 4 | ~~[TASK-095](closed/task-095-tutorial-steps-4-6-erc-bom-iteration.md)~~ | ~~Tutorial — steps 4-6 (ERC fix, BOM export, layout iteration)~~ | 🟢 closed | Medium (2-8h) |
| 5 | ~~[TASK-096](closed/task-096-example-voltage-divider.md)~~ | ~~Example gallery — voltage divider~~ | 🟢 closed | Small (&lt;2h) |
| 6 | ~~[TASK-097](closed/task-097-example-common-emitter-amplifier.md)~~ | ~~Example gallery — common-emitter amplifier~~ | 🟢 closed | Medium (2-8h) |
| 7 | ~~[TASK-098](closed/task-098-example-555-monostable.md)~~ | ~~Example gallery — 555 monostable timer~~ | 🟢 closed | Medium (2-8h) |
| 8 | ~~[TASK-099](closed/task-099-example-opamp-non-inverting-buffer.md)~~ | ~~Example gallery — op-amp non-inverting buffer~~ | 🟢 closed | Medium (2-8h) |
| 9 | ~~[TASK-100](closed/task-100-example-multi-page-split.md)~~ | ~~Example gallery — multi-page split (stresses renderer page-break)~~ | 🟢 closed | Medium (2-8h) |
| 10 | ~~[TASK-101](closed/task-101-ci-regression-diff-for-gallery.md)~~ | ~~CI regression diff — regenerate the tutorial and gallery, fail on drift~~ | 🟢 closed | Medium (2-8h) |

## EPIC-013: Post-EPIC-006 Documentation Audit and Rewrite

[↑ back to top](#index)

**Status:** 🟢 closed — @branch: release/epic-013-post-epic-006-doc-audit — ██████████ 8/8 (100%)
...
graph LR
    ...
    TASK_107 --> TASK_109
    TASK_108 --> TASK_109
    click TASK_102 "closed/task-102-inventory-all-markdown-docs.md"
    click TASK_103 "closed/task-103-drift-sweep-stale-claims.md"
    click TASK_104 "closed/task-104-voice-unification-rewrite.md"
    click TASK_105 "closed/task-105-cross-reference-audit.md"
    click TASK_106 "closed/task-106-tutorial-alignment-with-epic-012.md"
    click TASK_107 "closed/task-107-test-plan-alignment-with-epic-011.md"
    click TASK_108 "closed/task-108-annotate-idea-001-dossier.md"
    click TASK_109 "closed/task-109-final-pass-readme-and-entry-points.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | ~~[TASK-102](closed/task-102-inventory-all-markdown-docs.md)~~ | ~~Inventory all .md docs and bucket by audience and freshness~~ | 🟢 closed | Small (&lt;2h) |
| 2 | ~~[TASK-103](closed/task-103-drift-sweep-stale-claims.md)~~ | ~~Drift sweep — identify stale claims, retired scripts, and broken refs~~ | 🟢 closed | Medium (2-8h) |
| 3 | ~~[TASK-104](closed/task-104-voice-unification-rewrite.md)~~ | ~~Voice unification — pick canonical voice and rewrite earlier docs forward~~ | 🟢 closed | Large (8-24h) |
| 4 | ~~[TASK-105](closed/task-105-cross-reference-audit.md)~~ | ~~Cross-reference audit — internal links, TASK/EPIC/IDEA refs, code-path mentions~~ | 🟢 closed | Small (&lt;2h) |
| 5 | ~~[TASK-106](closed/task-106-tutorial-alignment-with-epic-012.md)~~ | ~~Tutorial alignment — audit reference docs against EPIC-012's tutorial and gallery~~ | 🟢 closed | Small (&lt;2h) |
| 6 | ~~[TASK-107](closed/task-107-test-plan-alignment-with-epic-011.md)~~ | ~~Test-plan alignment — audit "how it's tested" sections against EPIC-011's plan~~ | 🟢 closed | Small (&lt;2h) |
| 7 | ~~[TASK-108](closed/task-108-annotate-idea-001-dossier.md)~~ | ~~Annotate the archived IDEA-001 dossier with what shipped vs what didn't~~ | 🟢 closed | Small (&lt;2h) |
| 8 | ~~[TASK-109](closed/task-109-final-pass-readme-and-entry-points.md)~~ | ~~Final pass on README.md and top-level entry-point docs~~ | 🟢 closed | Medium (2-8h) |

## EPIC-014: Component library and renderer v2 (sub-blocks, active devices, multi-page)

[↑ back to top](#index)

**Status:** 🟢 closed — @branch: release/epic-014-circuit-library-and-renderer-v2 — ██████████ 24/24 (100%)
...
graph LR
    ...
    TASK_132 --> TASK_133
    TASK_119 --> TASK_133
    click TASK_110 "closed/task-110-freeze-open-question-defaults.md"
    click TASK_111 "closed/task-111-kernel-rule-rc-low-pass.md"
    click TASK_112 "closed/task-112-kernel-rule-rc-high-pass.md"
    click TASK_113 "closed/task-113-kernel-rule-cc-decoupling-pair.md"
    click TASK_114 "closed/task-114-kernel-rule-rr-voltage-divider.md"
    click TASK_115 "closed/task-115-schema-sub-blocks-instances-ports.md"
    click TASK_116 "closed/task-116-netgraph-flattener-for-sub-block-instances.md"
    click TASK_117 "closed/task-117-sub-block-erc-rules.md"
    click TASK_118 "closed/task-118-renderer-inline-box-mode.md"
    click TASK_119 "closed/task-119-tutorial-step-3-rewrite-and-sub-block-docs.md"
    click TASK_120 "closed/task-120-component-profile-bjt-npn-and-pnp.md"
    click TASK_121 "closed/task-121-component-profile-ic-555.md"
    click TASK_122 "closed/task-122-component-profile-ic-opamp-dual-supply.md"
    click TASK_123 "closed/task-123-active-device-erc-rules.md"
    click TASK_124 "closed/task-124-schema-and-layout-engine-pages-partition.md"
    click TASK_125 "closed/task-125-renderer-multi-page-driver.md"
    click TASK_126 "closed/task-126-renderer-cross-page-net-labels.md"
    click TASK_127 "closed/task-127-cross-page-erc-rules.md"
    click TASK_128 "closed/task-128-gallery-reattempt-voltage-divider.md"
    click TASK_129 "closed/task-129-gallery-reattempt-common-emitter-amplifier.md"
    click TASK_130 "closed/task-130-gallery-reattempt-555-monostable.md"
    click TASK_131 "closed/task-131-gallery-reattempt-opamp-non-inverting-buffer.md"
    click TASK_132 "closed/task-132-gallery-reattempt-multi-page-split.md"
    click TASK_133 "closed/task-133-component-skill-docs-final-pass.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | ~~[TASK-110](closed/task-110-freeze-open-question-defaults.md)~~ | ~~Freeze open-question defaults for EPIC-014~~ | 🟢 closed | XS (&lt;30m) |
| 2 | ~~[TASK-111](closed/task-111-kernel-rule-rc-low-pass.md)~~ | ~~Kernel canonical rule — R + C low-pass~~ | 🟢 closed | Medium (2-8h) |
| 3 | ~~[TASK-112](closed/task-112-kernel-rule-rc-high-pass.md)~~ | ~~Kernel canonical rule — R + C high-pass~~ | 🟢 closed | Medium (2-8h) |
| 4 | ~~[TASK-113](closed/task-113-kernel-rule-cc-decoupling-pair.md)~~ | ~~Kernel canonical rule — C + C decoupling pair~~ | 🟢 closed | Medium (2-8h) |
| 5 | ~~[TASK-114](closed/task-114-kernel-rule-rr-voltage-divider.md)~~ | ~~Kernel canonical rule — R + R voltage divider with discriminator~~ | 🟢 closed | Medium (2-8h) |
| 6 | ~~[TASK-115](closed/task-115-schema-sub-blocks-instances-ports.md)~~ | ~~Schema extension — sub-blocks, instances, ports~~ | 🟢 closed | Medium (2-8h) |
| 7 | ~~[TASK-116](closed/task-116-netgraph-flattener-for-sub-block-instances.md)~~ | ~~Netgraph flattener for sub-block instances~~ | 🟢 closed | Large (8-24h) |
| 8 | ~~[TASK-117](closed/task-117-sub-block-erc-rules.md)~~ | ~~Sub-block ERC rules (4 rules)~~ | 🟢 closed | Medium (2-8h) |
| 9 | ~~[TASK-118](closed/task-118-renderer-inline-box-mode.md)~~ | ~~Renderer — inline-box mode for sub-block instances~~ | 🟢 closed | Medium (2-8h) |
| 10 | ~~[TASK-119](closed/task-119-tutorial-step-3-rewrite-and-sub-block-docs.md)~~ | ~~Tutorial step 3 rewrite + sub-block docs~~ | 🟢 closed | Medium (2-8h) |
| 11 | ~~[TASK-120](closed/task-120-component-profile-bjt-npn-and-pnp.md)~~ | ~~Component profile — bjt_npn and bjt_pnp~~ | 🟢 closed | Medium (2-8h) |
| 12 | ~~[TASK-121](closed/task-121-component-profile-ic-555.md)~~ | ~~Component profile — ic/555~~ | 🟢 closed | Small (&lt;2h) |
| 13 | ~~[TASK-122](closed/task-122-component-profile-ic-opamp-dual-supply.md)~~ | ~~Component profile — ic/opamp_dual_supply~~ | 🟢 closed | Small (&lt;2h) |
| 14 | ~~[TASK-123](closed/task-123-active-device-erc-rules.md)~~ | ~~Active-device ERC rules (BJT, op-amp, 555)~~ | 🟢 closed | Medium (2-8h) |
| 15 | ~~[TASK-124](closed/task-124-schema-and-layout-engine-pages-partition.md)~~ | ~~Schema + layout-engine — pages partition~~ | 🟢 closed | Medium (2-8h) |
| 16 | ~~[TASK-125](closed/task-125-renderer-multi-page-driver.md)~~ | ~~Renderer — multi-page driver~~ | 🟢 closed | Large (8-24h) |
| 17 | ~~[TASK-126](closed/task-126-renderer-cross-page-net-labels.md)~~ | ~~Renderer — cross-page net labels~~ | 🟢 closed | Medium (2-8h) |
| 18 | ~~[TASK-127](closed/task-127-cross-page-erc-rules.md)~~ | ~~Cross-page ERC rules (4 rules)~~ | 🟢 closed | Medium (2-8h) |
| 19 | ~~[TASK-128](closed/task-128-gallery-reattempt-voltage-divider.md)~~ | ~~Gallery re-attempt — voltage divider (supersedes TASK-096)~~ | 🟢 closed | Small (&lt;2h) |
| 20 | ~~[TASK-129](closed/task-129-gallery-reattempt-common-emitter-amplifier.md)~~ | ~~Gallery re-attempt — common-emitter amplifier (supersedes TASK-097)~~ | 🟢 closed | Small (&lt;2h) |
| 21 | ~~[TASK-130](closed/task-130-gallery-reattempt-555-monostable.md)~~ | ~~Gallery re-attempt — 555 monostable (supersedes TASK-098)~~ | 🟢 closed | Small (&lt;2h) |
| 22 | ~~[TASK-131](closed/task-131-gallery-reattempt-opamp-non-inverting-buffer.md)~~ | ~~Gallery re-attempt — op-amp non-inverting buffer (supersedes TASK-099)~~ | 🟢 closed | Small (&lt;2h) |
| 23 | ~~[TASK-132](closed/task-132-gallery-reattempt-multi-page-split.md)~~ | ~~Gallery re-attempt — multi-page split (supersedes TASK-100)~~ | 🟢 closed | Medium (2-8h) |
| 24 | ~~[TASK-133](closed/task-133-component-skill-docs-final-pass.md)~~ | ~~Component-skill docs final pass~~ | 🟢 closed | Small (&lt;2h) |
...
```mermaid
graph LR
    TASK_134["TASK-134"]:::open
    TASK_135["TASK-135"]:::open
    TASK_060["TASK-060"]:::closed
    TASK_075["TASK-075"]:::closed
    TASK_060 ~~~ TASK_075 ~~~ TASK_134 ~~~ TASK_135
    click TASK_134 "open/task-134-fixtures-for-untriggered-erc-schema-checks.md"
    click TASK_135 "open/task-135-property-based-tests-router-and-netgraph.md"
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| ? | [TASK-134](open/task-134-fixtures-for-untriggered-erc-schema-checks.md) | Add triggering fixtures for untriggered ERC and schema checks | ⚪ _open_ | Medium (2-8h) |
| ? | [TASK-135](open/task-135-property-based-tests-router-and-netgraph.md) | Add property-based tests for the router and NetGraph form-equivalence | ⚪ _open_ | Medium (2-8h) |
