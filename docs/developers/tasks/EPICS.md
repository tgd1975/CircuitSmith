...
| [—](#unassigned) | _(no epic)_ | 🟢 closed | 0 | 0 | 0 | 4 | ██████████ 100% |
...
graph LR
    ...
    click TASK_134 "closed/task-134-fixtures-for-untriggered-erc-schema-checks.md"
    click TASK_135 "closed/task-135-property-based-tests-router-and-netgraph.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| ? | ~~[TASK-134](closed/task-134-fixtures-for-untriggered-erc-schema-checks.md)~~ | ~~Add triggering fixtures for untriggered ERC and schema checks~~ | 🟢 closed | Medium (2-8h) |
| ? | ~~[TASK-135](closed/task-135-property-based-tests-router-and-netgraph.md)~~ | ~~Add property-based tests for the router and NetGraph form-equivalence~~ | 🟢 closed | Medium (2-8h) |
