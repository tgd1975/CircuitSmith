...
**Overall:** 🔵 **active** — ███████░░░ 91/133 (68%) across 15 groups — 42 open · 0 active · 0 paused · 91 closed
...
| [EPIC-014](#epic-014-component-library-and-renderer-v2-sub-blocks-active-devices-multi-page) | Component library and renderer v2 (sub-blocks, active devices, multi-page) | ⚪ _open_ | 24 | 0 | 0 | 0 | ░░░░░░░░░░ 0% |
...
**Status:** ⚪ _open_ — ░░░░░░░░░░ 0/24 (0%)

```mermaid
graph LR
    TASK_110["TASK-110"]:::open
    TASK_111["TASK-111"]:::open
    TASK_112["TASK-112"]:::open
    TASK_113["TASK-113"]:::open
    TASK_114["TASK-114"]:::open
    TASK_115["TASK-115"]:::open
    TASK_116["TASK-116"]:::open
    TASK_117["TASK-117"]:::open
    TASK_118["TASK-118"]:::open
    TASK_119["TASK-119"]:::open
    TASK_120["TASK-120"]:::open
    TASK_121["TASK-121"]:::open
    TASK_122["TASK-122"]:::open
    TASK_123["TASK-123"]:::open
    TASK_124["TASK-124"]:::open
    TASK_125["TASK-125"]:::open
    TASK_126["TASK-126"]:::open
    TASK_127["TASK-127"]:::open
    TASK_128["TASK-128"]:::open
    TASK_129["TASK-129"]:::open
    TASK_130["TASK-130"]:::open
    TASK_131["TASK-131"]:::open
    TASK_132["TASK-132"]:::open
    TASK_133["TASK-133"]:::open
    TASK_110 --> TASK_111
    TASK_110 --> TASK_112
    TASK_110 --> TASK_113
    TASK_110 --> TASK_114
    ...
    TASK_132 --> TASK_133
    TASK_119 --> TASK_133
    click TASK_110 "open/task-110-freeze-open-question-defaults.md"
    click TASK_111 "open/task-111-kernel-rule-rc-low-pass.md"
    click TASK_112 "open/task-112-kernel-rule-rc-high-pass.md"
    click TASK_113 "open/task-113-kernel-rule-cc-decoupling-pair.md"
    click TASK_114 "open/task-114-kernel-rule-rr-voltage-divider.md"
    click TASK_115 "open/task-115-schema-sub-blocks-instances-ports.md"
    click TASK_116 "open/task-116-netgraph-flattener-for-sub-block-instances.md"
    click TASK_117 "open/task-117-sub-block-erc-rules.md"
    click TASK_118 "open/task-118-renderer-inline-box-mode.md"
    click TASK_119 "open/task-119-tutorial-step-3-rewrite-and-sub-block-docs.md"
    click TASK_120 "open/task-120-component-profile-bjt-npn-and-pnp.md"
    click TASK_121 "open/task-121-component-profile-ic-555.md"
    click TASK_122 "open/task-122-component-profile-ic-opamp-dual-supply.md"
    click TASK_123 "open/task-123-active-device-erc-rules.md"
    click TASK_124 "open/task-124-schema-and-layout-engine-pages-partition.md"
    click TASK_125 "open/task-125-renderer-multi-page-driver.md"
    click TASK_126 "open/task-126-renderer-cross-page-net-labels.md"
    click TASK_127 "open/task-127-cross-page-erc-rules.md"
    click TASK_128 "open/task-128-gallery-reattempt-voltage-divider.md"
    click TASK_129 "open/task-129-gallery-reattempt-common-emitter-amplifier.md"
    click TASK_130 "open/task-130-gallery-reattempt-555-monostable.md"
    click TASK_131 "open/task-131-gallery-reattempt-opamp-non-inverting-buffer.md"
    click TASK_132 "open/task-132-gallery-reattempt-multi-page-split.md"
    click TASK_133 "open/task-133-component-skill-docs-final-pass.md"
    classDef open    fill:#FAFAFA,stroke:#555,stroke-width:8px,color:#000
    classDef active  fill:#FAFAFA,stroke:#1A6FA8,stroke-width:8px,color:#000
    classDef closed  fill:#FAFAFA,stroke:#3F8B53,stroke-width:8px,color:#000
    classDef paused  fill:#FAFAFA,stroke:#B07810,stroke-width:8px,color:#000
...
| Order | ID | Title | Status | Effort |
|-------|----|-------|--------|--------|
| 1 | [TASK-110](open/task-110-freeze-open-question-defaults.md) | Freeze open-question defaults for EPIC-014 | ⚪ _open_ | XS (&lt;30m) |
| 2 | [TASK-111](open/task-111-kernel-rule-rc-low-pass.md) | Kernel canonical rule — R + C low-pass | ⚪ _open_ | Medium (2-8h) |
| 3 | [TASK-112](open/task-112-kernel-rule-rc-high-pass.md) | Kernel canonical rule — R + C high-pass | ⚪ _open_ | Medium (2-8h) |
| 4 | [TASK-113](open/task-113-kernel-rule-cc-decoupling-pair.md) | Kernel canonical rule — C + C decoupling pair | ⚪ _open_ | Medium (2-8h) |
| 5 | [TASK-114](open/task-114-kernel-rule-rr-voltage-divider.md) | Kernel canonical rule — R + R voltage divider with discriminator | ⚪ _open_ | Medium (2-8h) |
| 6 | [TASK-115](open/task-115-schema-sub-blocks-instances-ports.md) | Schema extension — sub-blocks, instances, ports | ⚪ _open_ | Medium (2-8h) |
| 7 | [TASK-116](open/task-116-netgraph-flattener-for-sub-block-instances.md) | Netgraph flattener for sub-block instances | ⚪ _open_ | Large (8-24h) |
| 8 | [TASK-117](open/task-117-sub-block-erc-rules.md) | Sub-block ERC rules (4 rules) | ⚪ _open_ | Medium (2-8h) |
| 9 | [TASK-118](open/task-118-renderer-inline-box-mode.md) | Renderer — inline-box mode for sub-block instances | ⚪ _open_ | Medium (2-8h) |
| 10 | [TASK-119](open/task-119-tutorial-step-3-rewrite-and-sub-block-docs.md) | Tutorial step 3 rewrite + sub-block docs | ⚪ _open_ | Medium (2-8h) |
| 11 | [TASK-120](open/task-120-component-profile-bjt-npn-and-pnp.md) | Component profile — bjt_npn and bjt_pnp | ⚪ _open_ | Medium (2-8h) |
| 12 | [TASK-121](open/task-121-component-profile-ic-555.md) | Component profile — ic/555 | ⚪ _open_ | Small (&lt;2h) |
| 13 | [TASK-122](open/task-122-component-profile-ic-opamp-dual-supply.md) | Component profile — ic/opamp_dual_supply | ⚪ _open_ | Small (&lt;2h) |
| 14 | [TASK-123](open/task-123-active-device-erc-rules.md) | Active-device ERC rules (BJT, op-amp, 555) | ⚪ _open_ | Medium (2-8h) |
| 15 | [TASK-124](open/task-124-schema-and-layout-engine-pages-partition.md) | Schema + layout-engine — pages partition | ⚪ _open_ | Medium (2-8h) |
| 16 | [TASK-125](open/task-125-renderer-multi-page-driver.md) | Renderer — multi-page driver | ⚪ _open_ | Large (8-24h) |
| 17 | [TASK-126](open/task-126-renderer-cross-page-net-labels.md) | Renderer — cross-page net labels | ⚪ _open_ | Medium (2-8h) |
| 18 | [TASK-127](open/task-127-cross-page-erc-rules.md) | Cross-page ERC rules (4 rules) | ⚪ _open_ | Medium (2-8h) |
| 19 | [TASK-128](open/task-128-gallery-reattempt-voltage-divider.md) | Gallery re-attempt — voltage divider (supersedes TASK-096) | ⚪ _open_ | Small (&lt;2h) |
| 20 | [TASK-129](open/task-129-gallery-reattempt-common-emitter-amplifier.md) | Gallery re-attempt — common-emitter amplifier (supersedes TASK-097) | ⚪ _open_ | Small (&lt;2h) |
| 21 | [TASK-130](open/task-130-gallery-reattempt-555-monostable.md) | Gallery re-attempt — 555 monostable (supersedes TASK-098) | ⚪ _open_ | Small (&lt;2h) |
| 22 | [TASK-131](open/task-131-gallery-reattempt-opamp-non-inverting-buffer.md) | Gallery re-attempt — op-amp non-inverting buffer (supersedes TASK-099) | ⚪ _open_ | Small (&lt;2h) |
| 23 | [TASK-132](open/task-132-gallery-reattempt-multi-page-split.md) | Gallery re-attempt — multi-page split (supersedes TASK-100) | ⚪ _open_ | Medium (2-8h) |
| 24 | [TASK-133](open/task-133-component-skill-docs-final-pass.md) | Component-skill docs final pass | ⚪ _open_ | Small (&lt;2h) |
