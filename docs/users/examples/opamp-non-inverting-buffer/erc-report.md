# ERC Report — Op-amp non-inverting buffer — 2026-05-14

| Severity | Ref | Pin | Check | Net | Message |
|---|---|---|---|---|---|
| ⚠️ WARNING | J1 | VBUS | E9 Reverse-polarity unprotected | V_PLUS | power input pin J1.VBUS on net 'V_PLUS' has no diode or P-MOSFET protection element. (WARNING at v0.1 pending the `diode` category.) |
| ⚠️ WARNING | J2 | VBUS | E9 Reverse-polarity unprotected | V_MINUS | power input pin J2.VBUS on net 'V_MINUS' has no diode or P-MOSFET protection element. (WARNING at v0.1 pending the `diode` category.) |
...
## ⚠️ J2.VBUS — E9 Reverse-polarity unprotected
