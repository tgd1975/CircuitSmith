...
def regenerate_idea_overview() -> None:
    # Idea OVERVIEW lives under IDEAS_DIR and is generated by a
    # sibling script. Without this hop, manual idea moves (or any
    # workflow that bypasses /ts-idea-new / /ts-idea-archive) silently
    # leave ideas/OVERVIEW.md stale.
...
def _read_version() -> str:
    ...
    candidate = Path(__file__).resolve().parent / "VERSION"
    if candidate.exists():
